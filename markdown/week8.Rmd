...
An image of this project as of *`r Sys.Date()* can be accessed by [clicking this link] (https://mybinder.org/v2/gh/anniegriebie/psy8960-week8.git/HEAD?urlpath=rstudio).
